...
public class DefaultSignerTest {
  protected static final long TEST_EPOCH_TIME = 1424700000L;
  protected static final String TEST_REQUEST_BODY = "Request Body";
  protected static final String EXPECTED_GET_AUTHENTICATION_HEADER =
  ...
  protected static final String EXPECTED_POST_AUTHENTICATION_HEADER =
  ...
  protected static final String MAUTH_TIME_HEADER = "x-mws-time";
  protected static final String MAUTH_AUTHENTICATION_HEADER = "x-mws-authentication";
  ...
  public void setUp() throws Exception {
    mAuthRequestSigner = new DefaultSigner(testUUID, privateKeyString);
  }
  ...
  public final void constructorWithInvalidKeyStringThrowsException() throws Exception {
    ...
    new DefaultSigner(testUUID, privateKeyString);
