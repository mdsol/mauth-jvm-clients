...
public class DefaultSignerTest {
  ...
  public final void generateHeadersIncludesTimeHeaderWithCorrectTime() throws Exception {
    ...
    assertEquals("Time in header does not equal expected test time", String.valueOf(TEST_EPOCH_TIME), headers.get(MAuthRequest.X_MWS_TIME_HEADER_NAME));
  }
  ...
  public final void generateHeadersIncludesExpectedAuthenticationHeader() throws Exception {
    ...
    assertEquals("Authentication header does not match expected value", EXPECTED_GET_AUTHENTICATION_HEADER, headers.get(MAuthRequest.X_MWS_AUTHENTICATION_HEADER_NAME));
  }
  ...
  public final void generateHeadersWithBodyIncludesExpectedAuthenticationHeader() throws Exception {
    ...
    assertEquals("Authentication header does not match expected value", EXPECTED_POST_AUTHENTICATION_HEADER, headers.get(MAuthRequest.X_MWS_AUTHENTICATION_HEADER_NAME));
  }
}